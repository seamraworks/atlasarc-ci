...
AtlasArc.io CI `1.0.0` is published on Maven Central and requires JDK 21 or newer. Use the
[standalone JAR](https://repo.maven.apache.org/maven2/io/atlasarc/atlasarc-ci/1.0.0/atlasarc-ci-1.0.0-standalone.jar)
directly, or download the
[standalone ZIP](https://repo.maven.apache.org/maven2/io/atlasarc/atlasarc-ci/1.0.0/atlasarc-ci-1.0.0-standalone.zip)
...
```shell
java -jar <path-to>/atlasarc-ci-1.0.0-standalone.jar evaluate \
...
`io.atlasarc:atlasarc-archunit:1.0.0`.
...
```kotlin
testImplementation("io.atlasarc:atlasarc-archunit:1.0.0")
...
```kotlin
implementation("io.atlasarc:atlasarc-governance-core:1.0.0")
```
