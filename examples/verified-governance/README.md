...
| Project | Standalone evaluator | ArchUnit/JUnit |
|---|---:|---:|
| [Java](jvm-cycle/README.md) | rejection + clean | rejection + clean |
| [TypeScript](typescript-cycle/README.md) | rejection + clean | not applicable |

The six GitHub jobs are expected-outcome assertions. A rejection job is green only when AtlasArc
...
[`jvm-cycle/pom.xml`](jvm-cycle/pom.xml). Both projects and all six verification cells use it.
