...
/** Converts ArchUnit-imported project classes into AtlasArc's portable evidence contract. */
        ...
        val attributionIssues = records.asSequence()
            ...
            .map { packageName ->
                GovernanceEvaluationIssue(
                    ...
                    message = "AtlasArc could not attribute JVM package '$packageName' to one stable module.",
